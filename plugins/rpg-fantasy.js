...
// 𝘔𝘖𝘋𝘌𝘈𝘋𝘖 𝘗𝘖𝘙 𝘎𝘓 𝘠𝘛 𝘔𝘟 - https://github.com/glytglobal/
...
jsonURL = 'https://github.com/WilsonOFC/MylingBot-MD/blob/main/views/img/Fantasy.json'
try {
...
let info = `*🌟 FANTASÍA RPG 🌟*\n*⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯*\n✓ 𝘕𝘖𝘔𝘉𝘙𝘌: ${dato.name}\n✓ 𝘖𝘙𝘐𝘎𝘌𝘕: ${dato.desp}\n✓ 𝘊𝘖𝘚𝘛𝘖: \`\`\`${dato.price}\`\`\` *${rpgshop.emoticon('money')}*\n✓ 𝘊𝘓𝘈𝘚𝘌: ${dato.class}\n✓ 𝘛𝘐𝘗𝘖: ${dato.type}\n✓ 𝘐𝘋: \`\`\`${codigoActual}\`\`\`\n*⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯⋯*\n✓ 𝘌𝘚𝘛𝘈𝘋𝘖: ${estado}`
