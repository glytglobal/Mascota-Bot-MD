...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE MASCOTA-BOT-MD 🌟`}
...
const smsLista7 = () => { return `😼 INSTALAR MASCOTABOT 😼`}
const smsLista8 = () => { return `😼 SER MASCOTA SUB-BOT 😼`}
...
//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✨ 𝗕𝗜𝗘𝗡𝗩𝗘𝗡𝗜𝗗𝗢(𝗔) 𝗠𝗔𝗦𝗖𝗢𝗧𝗔 😼!!*\n┊💖 @user\n┊📄 *𝗟𝗘𝗔 𝗠𝗔𝗦𝗖𝗢𝗧𝗔 𝗟𝗔 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗖𝗜𝗢𝗡 𝗗𝗘𝗟 𝗚𝗥𝗨𝗣𝗢*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *𝗡𝗢 𝗟𝗘 𝗦𝗔𝗕𝗘 𝗔 𝗦𝗘𝗥 𝗨𝗡𝗔 𝗠𝗔𝗦𝗖𝗢𝗧𝗔, 𝗖𝗛𝗔𝗨!!* 😼\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*🫵😼 @user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝙐𝙉 𝙈𝘼𝙎𝘾𝙊𝙏𝘼 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍𝘼 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdemote = () => { return '*🫵😼 @user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝙐𝙉𝘼 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍𝘼 𝙈𝘼𝙎𝘾𝙊𝙏𝘼 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗦𝗨𝗣𝗘𝗥 - 𝗠𝗔𝗦𝗖𝗢𝗧𝗔 😼'} 
const smsApagar = () => { return '❌ 𝖣𝖤𝖲𝖠𝖢𝖳𝖨𝖵𝖠𝖱'} 
const smsEncender = () => { return '✅ 𝖠𝖢𝖳𝖨𝖵𝖠𝖱'} 
const smsEnlaceTik = () => { return `𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝘿𝙀 𝙏𝙄𝙆𝙏𝙊𝙆 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀 𝙈𝘼𝙎𝘾𝙊𝙏𝘼 😼`}
...
const smsSoloOwner = () => { return `𝙐𝙁𝙁 𝙈𝘼𝙎𝘾𝙊𝙏𝘼 𝙀𝙇/𝙇𝘼 𝙋𝙍𝙊𝙋𝙄𝙀𝙏𝘼𝙍𝙄𝙊(𝘼) 𝘿𝙀𝘽𝙀 𝘼𝘾𝙏𝙄𝙑𝘼𝙍 𝙀𝙎𝙏𝘼 𝙁𝙐𝙉𝘾𝙄𝙊𝙉\n*#on restrict*`}

//handler.js
const smsCont1 = () => { return `*🔴 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 𝗛𝗘𝗖𝗛𝗢 𝗣𝗘𝗟𝗢𝗧𝗔 🔴*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}𝘾𝙊𝙈𝙊 𝙀𝙍𝙀𝙎 𝙐𝙉𝘼 𝙈𝘼𝙎𝘾𝙊𝙏𝘼 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙉𝙊 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼)`}
...
//_antitoxic.js
const smsToxic1 = () => { return `𝙉𝙊𝙊!!! 🤬 𝘿𝙀𝘾𝙄𝙍 𝙀𝙎𝙏𝘼 𝙋𝘼𝙇𝘼𝘽𝙍𝘼 𝙈𝘼𝙎𝘾𝙊𝙏𝘼`}
const smsToxic2 = () => { return `𝙀𝙎𝙏𝘼 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝘼 𝙉𝙊 𝙎𝙀𝘼𝙎 𝙏𝙊𝙓𝙄𝘾𝙊(𝘼) 𝙈𝘼𝙎𝘾𝙊𝙏𝙄𝙏𝘼`}
...
const eGataCoins = () => { return '🐱 MascotaCoins' }
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar MascotaBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar MascotaBot en Grupos`}
...
//_antiviewonce.js
const smsAntiView = () => { return `*𝙈𝘼𝙎𝘾𝙊𝙏𝘼 𝙇𝙊 𝙑𝙀𝙊 𝙏𝙊𝘿𝙊 𝘼𝙌𝙐𝙄* 😎`} 
...
//afk-_afk.js
const smsAfkM1 = () => { return `*𝗗𝗘𝗝𝗔𝗦𝗧𝗘 𝗗𝗘 𝗘𝗦𝗧𝗔𝗥 𝗜𝗡𝗔𝗖𝗧𝗜𝗩𝗢(𝗔) 𝗠𝗔𝗦𝗖𝗢𝗧𝗔 𝗔𝗙𝗞*`} 
const smsAfkM2 = () => { return `\n*𝗘𝗟 𝗠𝗢𝗧𝗜𝗩𝗢 𝗗𝗘 𝗟𝗔 𝗠𝗔𝗦𝗖𝗢𝗧𝗔 𝗜𝗡𝗔𝗖𝗧𝗜𝗩𝗜𝗗𝗔𝗗 𝗘𝗥𝗔:*\n`} 
const smsAfkM3 = () => { return `⏳ *𝗧𝗜𝗘𝗠𝗣𝗢 𝗜𝗡𝗔𝗖𝗧𝗜𝗩𝗢(𝗔):*`} 
const smsAfkM4 = () => { return `*¡𝗢𝗬𝗘! 𝗡𝗢 𝗘𝗧𝗜𝗤𝗨𝗘𝗧𝗘𝗦 𝗔 𝗘𝗦𝗧𝗘(𝗔) 𝗠𝗔𝗦𝗖𝗢𝗧𝗔!! 𝗘𝗦𝗧𝗔 𝗜𝗡𝗔𝗖𝗧𝗜𝗩𝗢(𝗔)*\n`} 
...
const smsGrupoTime7 = () => { return '🔒 *EL GRUPO ESTA CERRADO, SOLO ADMINISTRADORES MASCOTA PUEDEN ENVIAR MENSAJES*'}
const smsGrupoTime8 = () => { return '🔓 *EL GRUPO ESTA ABIERTO, TODOS LOS MASCOTAS PUEDEN ENVIAR MENSAJES*'}
...
const smsAddB6 = () => { return `𝖲𝖮𝖫𝖨𝖢𝖨𝖳𝖠𝖭𝖣𝖮 𝖠 𝖫𝖮𝖲 𝖠𝖣𝖬𝖨𝖭𝖨𝖲𝖳𝖱𝖠𝖣𝖮𝖱𝖤𝖲 𝖬𝖠𝖲𝖢𝖮𝖳𝖠𝖲 𝖯𝖮𝖱 𝖥𝖠𝖵𝖮𝖱.`}
...
const smsAdveu7 = () => { return '*𝖳𝖤 𝖫𝖮 𝖠𝖣𝖵𝖤𝖱𝖳𝖨 𝖵𝖠𝖱𝖨𝖠𝖲 𝖵𝖤𝖢𝖤𝖲 𝖬𝖠𝖲𝖢𝖮𝖳𝖠!!*'}
const smsAdveu8 = () => { return '*𝖠𝖧𝖮𝖱𝖠 𝖲𝖤𝖱𝖠́𝖲 𝖤𝖫𝖨𝖬𝖨𝖭𝖠𝖣𝖮(𝖠) 𝖬𝖠𝖲𝖢𝖮𝖳𝖠* 😼'}
const smsAdveu9 = () => { return '😇 MUCHAS GRACIAS'}
const smsAdveu10 = () => { return '*SE LE ELIMINÓ UNA ADVERTENCIA A LA MASCOTA DE ESTE GRUPO!!*'}
...
const smsDemott2 = () => { return '*AHORA TIENE PODER EN EL GRUPO POR MASCOTA!!*'}
const smsDemott3 = () => { return '*YA NO TIENE PODER EN EL GRUPO POR MASCOTA!!*'}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeGB['smsAvisoAG']()}*ETIQUETE A LA PERSONA O RESPONDA AL MENSAJE DE LA PERSONA QUE QUIERE ELIMINAR MASCOTA*\n\n*EJEMPLO: `}
const smskick2 = () => { return `ELIMINADO(A) POR MASCOTA 🫵😼`}
const smskick3 = () => { return `NO PUEDO ELIMINAR AL CREADOR DEL GRUPO MASCOTA 🫵😆`}
const smskick4 = () => { return `NO SEAS PENDEJO(A) MASCOTA, NO ESTÁ EN ESTE GRUPO 👻`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙈𝘼𝙎𝘾𝙊𝙏𝘼𝘽𝙊𝙏-𝙈𝘿 😼\n\n💖 𝙈𝘼𝙎𝘾𝙊𝙏𝘼𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝙊(𝘼) 𝙋𝙊𝙍:\n@${user}`}
...
//jadibot-serbot.js
const smsIniJadi = () => { return `*✿◈ 𝙈𝙖𝙨𝙘𝙤𝙩𝙖-𝘽𝙤𝙩-𝙈𝘿 ◈✿*\n\n*➥ VERSION DE MASCOTA-BOT-MD 😼 » _${global.vs}_*\n*➥ VERSION DE SUB-BOT » _${global.vsJB}_*\n\n✿ *_FUNCIÓN SER SUB BOT_* ✿\n\n*✿ 𝖢𝖮𝖭 𝖮𝖳𝖱𝖮 𝖣𝖨𝖲𝖯𝖮𝖲𝖨𝖳𝖨𝖵𝖮 𝖢𝖤𝖫𝖴𝖫𝖠𝖱/𝖯𝖢 𝖤𝖲𝖢𝖠𝖭𝖤𝖤 𝖤𝖲𝖳𝖤 𝖢𝖮𝖣𝖨𝖦𝖮 𝖰𝖱 𝖯𝖠𝖱𝖠 𝖢𝖮𝖭𝖵𝖤𝖱𝖳𝖨𝖱𝖲𝖤 𝖤𝖭 𝖴𝖭 𝖲𝖴𝖡-𝖡𝖮𝖳 𝖣𝖤 𝖬𝖠𝖲𝖢𝖮𝖳𝖠-𝖡𝖮𝖳-𝖬𝖣*\n\n𝖯𝖠𝖲𝖮𝖲:\n\n*𝟣 - 𝖣𝖨𝖱𝖨𝖩𝖠𝖲𝖤 𝖤𝖭 𝖫𝖮𝖲 𝖳𝖱𝖤𝖲 𝖯𝖴𝖭𝖳𝖮𝖲 𝖤𝖭 𝖫𝖠 𝖤𝖲𝖰𝖴𝖨𝖭𝖠 𝖲𝖴𝖯𝖤𝖱𝖨𝖮𝖱 𝖣𝖤𝖱𝖤𝖢𝖧𝖠\n*𝟤 - 𝖨𝖱 𝖠 𝖫𝖠 𝖮𝖯𝖢𝖨𝖮𝖭 𝖣𝖤 𝖣𝖨𝖲𝖯𝖮𝖲𝖨𝖳𝖨𝖵𝖮𝖲 𝖵𝖨𝖭𝖢𝖴𝖫𝖠𝖣𝖮𝖲*\n*𝟥 - 𝖤𝖲𝖢𝖠𝖭𝖤𝖤 𝖤𝖲𝖳𝖤 𝖢𝖮𝖣𝖨𝖦𝖮 𝖰𝖱 𝖯𝖠𝖱𝖠 𝖨𝖭𝖨𝖢𝖨𝖠𝖱 𝖲𝖤𝖲𝖨𝖮𝖭*\n\n🜲 𝖠𝖳𝖤𝖭𝖢𝖨𝖮𝖭: *¡𝖤𝖲𝖳𝖤 𝖢𝖮𝖣𝖨𝖦𝖮 𝖤𝖷𝖯𝖨𝖱𝖠 𝖤𝖭 𝖤𝖭 𝟦𝟧-𝟨𝟢 𝖲𝖤𝖦𝖴𝖭𝖣𝖮𝖲!*`}
const smsIniJadi2 = () => { return `*◉ 𝙈𝙖𝙨𝙘𝙤𝙩𝙖-𝘽𝙤𝙩-𝙈𝘿 ◉*\n\n*➥ VERSION DE MASCOTA-BOT-MD 😼 » _${global.vs}_*
*➥ 𝖵𝖤𝖱𝖲𝖨𝖮𝖭 𝖣𝖤 𝖲𝖴𝖡-𝖡𝖮𝖳 » _${global.vsJB}_*\n\n😼 *_NUEVA FUNCIÓN DE HACERTE UN SUB BOT_* 😼\n\n*𝟣 - 𝖣𝖨𝖱𝖨𝖩𝖠𝖲𝖤 𝖠 𝖫𝖠 𝖤𝖲𝖰𝖴𝖨𝖭𝖠 𝖲𝖴𝖯𝖤𝖱𝖨𝖮𝖱 𝖣𝖤𝖱𝖤𝖢𝖧𝖠*\n*𝟤 - 𝖣𝖨𝖱𝖨𝖩𝖠𝖲𝖤 𝖠 𝖫𝖠 𝖮𝖯𝖢𝖨𝖮𝖭 𝖣𝖤 "𝖣𝖨𝖲𝖯𝖮𝖲𝖨𝖳𝖨𝖵𝖮𝖲 𝖵𝖨𝖭𝖢𝖴𝖫𝖠𝖣𝖮𝖲"*\n*𝟥 - 𝖧𝖠𝖦𝖠 𝖢𝖫𝖨𝖢𝖪 𝖤𝖭 𝖵𝖨𝖭𝖢𝖴𝖫𝖠𝖱 𝖣𝖨𝖲𝖯𝖮𝖲𝖨𝖳𝖨𝖵𝖮 𝖲𝖤𝖱𝖦𝖴𝖨𝖣𝖮 𝖯𝖠𝖲𝖮 "𝖵𝖨𝖭𝖢𝖴𝖫𝖠𝖱 𝖢𝖮𝖭 𝖢𝖮𝖣𝖨𝖦𝖮 𝖣𝖤 𝖳𝖤𝖫𝖤𝖥𝖮𝖭𝖮"*\n*𝟦 - 𝖯𝖤𝖦𝖠 𝖮 𝖨𝖭𝖲𝖤𝖱𝖳𝖤 𝖤𝖫 𝖢𝖮𝖣𝖨𝖦𝖮 𝖠 𝖢𝖮𝖭𝖳𝖨𝖭𝖴𝖠𝖢𝖨𝖮𝖭*`}
const smsSoloOwnerJB = () => { return `${lenguajeGB['smsAvisoAG']()}*𝖤𝖲𝖳𝖤 𝖢𝖮𝖬𝖠𝖭𝖣𝖮 𝖤𝖲𝖳𝖠 𝖣𝖤𝖲𝖠𝖢𝖳𝖨𝖵𝖠𝖣𝖮 𝖯𝖮𝖱 𝖬𝖨 𝖯𝖱𝖮𝖯𝖨𝖤𝖳𝖠𝖱𝖨𝖮(𝖠) 𝖬𝖠𝖲𝖢𝖮𝖳𝖠 😼🫵*`}
const smsJBPrincipal = () => { return `${lenguajeGB['smsAvisoAG']()}🌟 *𝖯𝖠𝖱𝖠 𝖲𝖤𝖱 𝖴𝖭 𝖲𝖴𝖡-𝖡𝖮𝖳 𝖣𝖤 𝖬𝖠𝖲𝖢𝖮𝖳𝖠-𝖡𝖮𝖳-𝖬𝖣 😼\n\n*𝖣𝖨𝖱𝖨𝖩𝖠𝖲𝖤 𝖠𝖫 𝖭𝖴𝖬𝖤𝖱𝖮 𝖯𝖱𝖨𝖭𝖢𝖨𝖯𝖠𝖫 𝖣𝖤𝖫 𝖡𝖮𝖳*\n\n*𝖨𝖭𝖦𝖱𝖤𝖲𝖠 𝖠𝖫 𝖲𝖨𝖦𝖴𝖨𝖤𝖭𝖳𝖤 𝖤𝖭𝖫𝖠𝖢𝖤 𝖬𝖠𝖲𝖢𝖮𝖳𝖠 😼🫵:*\n`}
const smsreenvia = () => { return `*⚠️ 𝖱𝖤𝖤𝖭𝖵𝖨𝖠 𝖤𝖫 𝖢𝖮𝖬𝖠𝖭𝖣𝖮...*`}
const smsJBConexion = () => { return `${lenguajeGB['smsAvisoFG']()}⚠️ *𝖫𝖠 𝖢𝖮𝖭𝖤𝖷𝖨𝖮𝖭 𝖲𝖤 𝖢𝖤𝖱𝖱𝖮 𝖣𝖤 𝖥𝖮𝖱𝖬𝖠 𝖨𝖭𝖤𝖲𝖯𝖤𝖱𝖠𝖣𝖠, 𝖱𝖤𝖢𝖮𝖭𝖤𝖢𝖳𝖠𝖭𝖣𝖮..* ⚠️`}
const smsJBConexionClose = () => { return `${lenguajeGB['smsAvisoFG']()}⛔ *𝖫𝖠 𝖢𝖮𝖭𝖤𝖷𝖨𝖮𝖭 𝖲𝖤 𝖠𝖧 𝖢𝖤𝖱𝖱𝖠𝖣𝖮, 𝖣𝖤𝖡𝖤𝖱𝖠 𝖵𝖮𝖫𝖵𝖤𝖱 𝖠 𝖢𝖮𝖭𝖤𝖢𝖳𝖠𝖱𝖲𝖤 𝖢𝖮𝖭 𝖤𝖫 𝖢𝖮𝖬𝖠𝖭𝖣𝖮 #𝖲𝖤𝖱𝖡𝖮𝖳 𝖸 𝖱𝖤𝖤𝖲𝖢𝖠𝖭𝖤𝖠𝖱 𝖤𝖫 𝖢𝖮𝖣𝖨𝖦𝖮 𝖰𝖱*`}
const smsJBConexionClose2 = () => { return `${lenguajeGB['smsAvisoFG']()}❗️ *𝖫𝖠 𝖢𝖮𝖭𝖤𝖷𝖨𝖮́𝖭 𝖲𝖤 𝖧𝖠 𝖢𝖤𝖱𝖱𝖠𝖣𝖮, 𝖳𝖤𝖭𝖣𝖱𝖠𝖲 𝖰𝖴𝖤 𝖵𝖮𝖫𝖵𝖤𝖱 𝖠 𝖢𝖮𝖭𝖤𝖢𝖳𝖠𝖱𝖲𝖤 𝖴𝖲𝖠𝖭𝖣𝖮:*\n#DELETERSESION  (𝖯𝖠𝖱𝖠 𝖡𝖮𝖱𝖱𝖠𝖱 𝖫𝖮𝖲 𝖣𝖠𝖳𝖮𝖲 𝖸 𝖯𝖮𝖣𝖤𝖱 𝖵𝖮𝖫𝖵𝖤𝖱 𝖠 𝖲𝖮𝖫𝖨𝖳𝖠𝖱 𝖤𝖫 𝖰𝖱 𝖮 𝖤𝖫 𝖢𝖮𝖣𝖤)`}
const smsJBConexionTrue = () => { return `${lenguajeGB['smsAvisoEG']()}✅ *𝖬𝖠𝖲𝖢𝖮𝖳𝖠 𝖢𝖮𝖭𝖤𝖢𝖳𝖠𝖣𝖠 𝖢𝖮𝖭 𝖤𝖷𝖨𝖳𝖮!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeGB['smsAvisoEG']()}😼 *𝖢𝖮𝖭𝖤𝖷𝖨𝖮́𝖭 𝖢𝖮𝖭 𝖤́𝖷𝖨𝖳𝖮 𝖬𝖠𝖲𝖢𝖮𝖳𝖠!!! 𝖯𝖴𝖤𝖣𝖤 𝖢𝖮𝖭𝖤𝖢𝖳𝖠𝖱𝖲𝖤 𝖴𝖲𝖠𝖭𝖣𝖮 𝖲𝖴 (𝖨𝖣) 𝖮 𝖴𝖲𝖠𝖱 𝖤𝖫 𝖢𝖮𝖬𝖠𝖭𝖣𝖮 #𝖲𝖤𝖱𝖡𝖮𝖳 𝖯𝖠𝖱𝖠 𝖱𝖤𝖢𝖮𝖭𝖤𝖳𝖠𝖱𝖲𝖤:*`}
const smsJBCargando = () => { return `${lenguajeGB['smsAvisoIIG']()}😼🫵 𝖢𝖮𝖭𝖤𝖢𝖳𝖠𝖣𝖮(𝖠) 𝖢𝖮𝖭 𝖤𝖷𝖨𝖳𝖮 𝖢𝖮𝖭 𝖬𝖠𝖲𝖢𝖮𝖳𝖠\n\n𝖲𝖤 𝖤𝖲𝖳𝖠 𝖢𝖠𝖱𝖦𝖠𝖭𝖣𝖮 𝖫𝖮𝖲 𝖬𝖤𝖭𝖲𝖠𝖩𝖤𝖲 𝖣𝖤𝖫 𝖡𝖮𝖳 😺\n\n*𝖮𝖯𝖢𝖨𝖮𝖭𝖤𝖲 𝖣𝖨𝖲𝖯𝖮𝖭𝖨𝖡𝖫𝖤𝖲:*\n*» /stop - (Detener la función Sub Bot)*\n*» /eliminarsesion - (Borrar todo rastro de Sub Bot)*\n*» /serbot - (Obtener nuevo código QR para ser Sub Bot)*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Mascota-Bot-MD 😼'}
