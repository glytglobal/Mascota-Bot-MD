...
if wget -q https://github.com/glytglobal/Mascota-Bot-MD/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/WilsonOFC/Mascota-Bot-MD\ncd Mascota\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[2;35m"
git clone https://github.com/glytglobal/Mascota-Bot-MD.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} Mascota-Bot-MD${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/IegNpepyhYb4OqUjLvshgO &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando Mascota-Bot-MD 😼!!\nStarting Mascota-Bot-MD 😼!!\n\033[0m"
npm run qr
